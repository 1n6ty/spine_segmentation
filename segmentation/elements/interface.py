...
from segmentation.medical_parameters.parameters import Vertebrae_Parameters, Gap_Parameters
...
class Vertebrae():
    ...
    name: str | None = None
    parameters: Vertebrae_Parameters | None = None
    ...
    def compute_parameters(self, projection: Literal["side", "frontal"]) -> None:
        self.parameters = Vertebrae_Parameters(self, self.name, projection)
