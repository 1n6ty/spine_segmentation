...
function screenToWorld(point: Point, offset: Point, scale: Point): Point {
    return {
...
export { screenToWorld, getPolygonCenter, getDistance, getSignedAngle, distance, vectorSub, dotProduct, vectorNorm, toDegrees, solveCircleFit };