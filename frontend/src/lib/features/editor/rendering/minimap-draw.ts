...
export function drawMinimap(
	...
	const { x: worldX, y: worldY } = screen_to_world({ x: 0, y: 0 }, mainView.offset, mainView.scale);
	...
	ctx.strokeRect(imgX + worldX * ratio, imgY + worldY * ratio, worldW * ratio, worldH * ratio);
